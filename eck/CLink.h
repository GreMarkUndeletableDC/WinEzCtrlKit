...
public:
    ...
    ECK_W_STYLE(Transparent, LWS_TRANSPARENT);
    ECK_W_STYLE(IgnoreReturn, LWS_IGNORERETURN);
    ECK_W_STYLE(NoPrefix, LWS_NOPREFIX);
    ECK_W_STYLE(UseVisualStyle, LWS_USEVISUALSTYLE);
    ECK_W_STYLE(UseCustomText, LWS_USECUSTOMTEXT);
    ECK_W_STYLE(AlignmentRight, LWS_RIGHT);
