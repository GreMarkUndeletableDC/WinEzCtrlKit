...
public:
    ...
    ECK_W_STYLE(AutoTicks, TBS_AUTOTICKS);
    ECK_W_STYLE(Vertical, TBS_VERT);
    ECK_W_STYLE(Horizontal, TBS_HORZ);
    ECK_W_STYLE(TicksTop, TBS_TOP);
    ECK_W_STYLE(TicksBottom, TBS_BOTTOM);
    ...
    ECK_W_STYLE(ToolTips, TBS_TOOLTIPS);
