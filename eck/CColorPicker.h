...
public:
    ...
    constexpr static int CustomIndex = 1;
private:
    COLORREF m_crCustom{ CLR_INVALID };
    COLORREF m_crCcDlgCustom[16]{};

    constexpr static struct PERSET_COLOR
    {
        COLORREF cr;
    ...
    constexpr static int ColorBlockWidth = 20;
public:
        ...
        case WM_NOTIFY:
        {
            ...
            case NM_CBN_LBCUSTOMDRAW:
            {
                ...
                case CDDS_ITEMPOSTPAINT:
                {
                    ...
                    int cxClrBlock = DpiScale(ColorBlockWidth, m_iDpi);
