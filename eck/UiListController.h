...
private:
    ...
    TCoord m_cyTopExtra{};    // 顶部空白
    TCoord m_cyBottomExtra{}; // 底部空白

    TCoord m_cyItem{ 40 };    // 项目高度
    TCoord m_cyPadding{ 4 };  // 项目间距
    ...
    BITBOOL m_bDeSelInSpace : 1{ TRUE };
    BITBOOL m_bDbgIndex : 1{};
    BITBOOL m_bCustomDraw : 1{};
...
public:
    ...
    void ReCalculateScrollV() noexcept
    {
        ...
        m_pHost->LchSccSetRange(TRUE, -m_cyTopExtra, cyContent + m_cyBottomExtra);
    }
