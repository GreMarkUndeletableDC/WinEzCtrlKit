...
public:
    ...
    ECK_W_NONATTACHABLE(CLabel);
    ECK_W_CREATE_CLASS_INST(WCN_LABEL, g_hInstance);
...
private:
    ...
    constexpr UINT DtAlignmentH() const noexcept
    {
        switch (m_eAlignH)
        {
    ...
    void Paint(HDC hDC, const RECT& rcPaint) noexcept
    {
        ...
        // 画文本
        const UINT uDTFlags = DT_NOCLIP | DtEllipsis() | DtPrefix() | DtAlignmentH() |
    ...
    LRESULT OnMessage(UINT uMsg, WPARAM wParam, LPARAM lParam) noexcept override
    {
        ...
        case WM_NCHITTEST:
        {
            if (m_bTransparent)
                ...
                {
                case MouseOption::TransparentSpace:
                {
