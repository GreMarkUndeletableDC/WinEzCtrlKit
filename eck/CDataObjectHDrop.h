...
private:
    ...
    EckInline auto FindFormat(FORMATETC* pFormatEtc) noexcept
    {
...
public:
    static HRESULT CopyHGlobal(
        HGLOBAL hGlobalDst,
        HGLOBAL hGlobalSrc,
        size_t cb = 0) noexcept
    {
    ...
    static HRESULT DuplicateHGlobal(
        HGLOBAL hGlobalSrc,
        _Out_ HGLOBAL& hGlobalDst,
